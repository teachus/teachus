			...
			public void run() {
				mailSender.send(new MimeMessagePreparator() {
					public void prepare(MimeMessage mimeMessage) throws Exception {
						...
						// Load the properties
						ResourceBundle bundle = ResourceBundle.getBundle("dk.teachus.bean.impl.WelcomeMail", locale);
		...
		if (pupilBookings.isEmpty() == false) {
			mailSender.send(new MimeMessagePreparator() {
				public void prepare(MimeMessage mimeMessage) throws Exception {
					...
					// Load properties
					ResourceBundle bundle = ResourceBundle.getBundle("dk.teachus.bean.impl.NewBookingsMail", locale);	
