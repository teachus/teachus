...
public class DatePeriodImpl implements Serializable, DatePeriod {
	...
	/* (non-Javadoc)
	 * @see dk.frankbille.teachus.domain.impl.DatePeriod#getDate()
	 */
	public Date getDate() {
		return date;
	}
	...
	/* (non-Javadoc)
	 * @see dk.frankbille.teachus.domain.impl.DatePeriod#getPeriods()
	 */
	...
	/* (non-Javadoc)
	 * @see dk.frankbille.teachus.domain.impl.DatePeriod#addPeriod(dk.frankbille.teachus.domain.Period)
	 */
