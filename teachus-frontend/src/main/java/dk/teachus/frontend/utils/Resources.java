...
public abstract class Resources {
	...
	public static final ResourceReference SCREENSHOT_10 = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot10.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_10_THUMB = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot10_thumb.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_11 = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot11.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_11_THUMB = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot11_thumb.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_12 = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot12.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_12_THUMB = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot12_thumb.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_13 = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot13.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_13_THUMB = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot13_thumb.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_14 = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot14.jpg"); //$NON-NLS-1$;
	public static final ResourceReference SCREENSHOT_14_THUMB = new ResourceReference(TeachUsApplication.class, "resources/screenshots/screenshot14_thumb.jpg"); //$NON-NLS-1$;
